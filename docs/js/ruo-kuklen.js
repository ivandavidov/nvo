...
ruoSchools["1601102"] = {n: "ПГ по селско стоп.", f: "ПГ по селско стопанство", c: false, p: {
  "28208": {n: "Механизация и цифровизация в аграрния сектор", d: [
    [null, null, null, null],
    [[42,42,72,191,158,191], null, [46,84,46,158.5,158.5,46], null]
  ]},
}};
ruoSchools["1601101"] = {n: "СУ Отец Паисий", f: "СУ Отец Паисий", c: false, p: {
  "5124": {n: "Административни и офис дейности", d: [
    ...
    [[55.5,55.5,88,326.25,246,326.25], [176,0,176,176,0,176], [359.25,0,359.25,359.25,0,359.25], [134,0,134,134,0,134]]
  ]},
}};
