...
Този проект дава възможност за графично (визуално) сравнение на училищата в България според резултатите на учениците от НВО и ДЗИ. Наличните данни са взети от портала [data.egov.bg](https://data.egov.bg).
...
* Колекция от мини игри с поддръжка за клавиатура и touch устройства
* Статичен JSON API с данни за училища, градове и класации — [документация](https://ivandavidov.github.io/nvo/api/v1/)
