...
data/
  ...
  ruo-{region}/       raw RUO files for the 7th-grade min/max scores pages, one dir per
                      ...
                      2026 so far: klasirane 1 only, for 19 of the 29 regions — Sofia,
                      Plovdiv, Varna, Burgas, Ruse, Stara Zagora + Blagoevgrad, Veliko
                      Turnovo, Dobrich, Kiustendil, Lovech, Vidin, Montana, Kurdzhali,
                      Pleven, Yambol (via tmp-ruo-2026/build.py) + Haskovo, Pernik, Vratsa
                      (own scripts; Vratsa 2026 via tmp-ruo-vraca/build_2026.py);
                      ...
                      source row with min>max dropped as impossible)
