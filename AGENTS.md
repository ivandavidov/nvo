...
### RUO / balove pipeline
The `balove` (min/max admission scores) pages now cover **~83 cities across 18 RUO regions**
(Sofia, Plovdiv, Varna, Burgas, Ruse, Stara Zagora, Pleven, Sliven, Dobrich, Shumen, Pernik,
Haskovo, Blagoevgrad, Yambol, Veliko Tarnovo, Pazardzhik, Vratsa, plus each region's smaller towns).
