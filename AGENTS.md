...
data/
  ...
  ruo-{region}/       raw RUO files for the 7th-grade min/max scores pages, one dir per
                      ...
                      2026 klasirane 1 only, imported for ALL 28 regions that published a
                      usable file — everything except Gabrovo. Most go through
                      ...
                      Gabrovo 2026 is an image-only PDF (NOT imported, needs OCR/machine-
                      readable file); Montana 2026 has one source row with min>max dropped
                      as impossible)
