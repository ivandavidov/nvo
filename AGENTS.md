...
### RUO / balove pipeline
The `balove` (min/max admission scores) pages now cover **~70 cities across 16 RUO regions**
(Sofia, Plovdiv, Varna, Burgas, Ruse, Stara Zagora, Pleven, Sliven, Dobrich, Shumen, Pernik,
Haskovo, Blagoevgrad, Yambol, Veliko Tarnovo, plus each region's smaller towns).
