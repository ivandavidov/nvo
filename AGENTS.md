...
### RUO / balove pipeline
The `balove` (min/max admission scores) pages now cover **~90 cities across 20 RUO regions**
(Sofia, Plovdiv, Varna, Burgas, Ruse, Stara Zagora, Pleven, Sliven, Dobrich, Shumen, Pernik,
Haskovo, Blagoevgrad, Yambol, Veliko Tarnovo, Pazardzhik, Vratsa, Gabrovo, Kurdzhali, plus each
region's smaller towns).
...
data/
  ...
  ruo-{region}/       raw RUO files for the 7th-grade min/max scores pages, one dir per
                      ...
                      ruo-pazardjik, ruo-vraca, ruo-gabrovo, ruo-kurdzhali)
