...
- Active sections: `4/`, `7/`, `10/`, `12/`, `stats/`, `games/`, `api/`
...
- `java/src/main/java/nvo/JsonGenerator.java` — generates `docs/api/v1/` (JSON endpoints + HTML docs)
...
1. Do not hand-edit generated files:
   ...
   - `docs/api/v1/` (all JSON files and `index.html` — regenerated by `JsonGenerator index`)
...
- API docs page loads with working dropdowns and correct links
